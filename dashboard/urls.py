...
from .views import Home,Helper_Profile,Yearly_Stats,Task_Details,Monthly_Stats
...
url(r'^monthly_stats/(?P<cat>[a-zA-Z]+)/(?P<month>[a-zA-Z]+)/(?P<year>[0-9]{4})/', Monthly_Stats.as_view(), name='monthly_stats'),
